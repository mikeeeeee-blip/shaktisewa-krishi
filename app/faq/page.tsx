    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Yes, our customer support team is available Monday through Saturday, 9 AM to 6 PM IST. You can reach us via phone (*9243143997), email (support@shaktisewa.com), or WhatsApp for quick assistance.',
        },
      ]
    },
  ];
      ...
      <div className="page-content">
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:9243143997" className="inline-flex items-center gap-2 bg-white text-green-600 px-6 py-3 rounded-lg font-semibold shadow-sm hover:shadow-md transition-shadow">
            ...
            <a href="https://wa.me/919243143997" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors">
